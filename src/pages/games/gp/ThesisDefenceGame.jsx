...
function ThesisDefenceGame() {
    ...
    return (
      <div className="scale-pop" style={{ background: T.bgCard, borderRadius: T.r3, padding: "36px 28px", textAlign: "center", border: `1px solid ${T.border}`, position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          ...
          <div style={{ fontSize: 32, fontWeight: 800, fontFamily: T.fontDisplay, color: T.text }}>{score} / {maxScore}</div>
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
      ...
      <div className="grain" style={{ background: "linear-gradient(135deg, #0F172A, #302050)", borderRadius: T.r3, padding: "16px 20px", color: "#fff", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        <div style={{ display: "flex", gap: 12, alignItems: "center" }}>
          <div style={{ textAlign: "center" }}>
            <div style={{ fontSize: 16, fontWeight: 800, color: "#D4A254", fontFamily: T.fontMono }}>{score}</div>
      ...
      {/* Essay question */}
      <div style={{ background: T.bgMuted, borderRadius: T.r2, padding: "12px 16px", fontSize: 13, fontWeight: 600, color: T.text, fontFamily: T.fontSerif, fontStyle: "italic", lineHeight: 1.6 }}>
        {q.question}
      </div>
