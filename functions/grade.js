import { applyCors, requireAuth, checkRateLimit } from "./lib/auth.js";

const API_URL = "https://api.anthropic.com/v1/messages";
const DEFAULT_MODEL = "claude-sonnet-4-6";

export async function gradeHandler(req, res) {
  applyCors(req, res);
  ...
  try {
    ...
    if (!apiRes.ok) {
      ...
      console.error(`[grade] Anthropic API ${apiRes.status}:`, errBody);
